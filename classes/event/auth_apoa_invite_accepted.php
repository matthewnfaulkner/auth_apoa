 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class auth_apoa_invite_accepted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('inviteaccepted', 'auth_apoa');
    }
    ...
    public function get_description() {
        return "The user with email '$this->userid' accepted the invitation to the congress.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/auth/apoa/inviteaccepted.php');
    }
